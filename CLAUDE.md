...
- Ошибка сканирования в FBS воспроизводит двухтональный Web Audio сигнал с gain `0.95`: полная громкость удерживается 0,5 с и затухает только последние 0,2 с. Успешное сканирование остаётся бесшумным.
