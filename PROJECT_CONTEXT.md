...
- `fbs.imaxprom.site` exposes only warehouse functions with its own login and organization switcher. Primary modules: `/fbs`, `/fbs-stock`, `/printer`; admin can also access employees/settings.
