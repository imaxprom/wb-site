...
const FORMULAS = [
  ...
  {
    title: "Налог (УСН)",
    formula: "(Сумма розничных продаж − НДС) × ставка УСН",
    source: "Расчёт на основе настроек",
    note: "По умолчанию ставка 1%. Сначала вычитается НДС из базы, потом считается УСН. Ставку можно изменить в настройках налогов",
  },
  {
    title: "НДС к уплате",
    formula: "Сумма розничных продаж × ставка НДС ÷ (100 + ставка НДС)",
    source: "Расчёт на основе настроек",
    note: "По умолчанию 5%. НДС уже включён в цену! Поэтому формула «÷ 105», а не «× 5%». Пример: товар за 1050₽ → НДС = 1050 × 5 ÷ 105 = 50₽. Ставку можно изменить в настройках налогов",
  },
  {
    title: "Себестоимость",
...
const NUANCES = [
  ...
  { q: "Почему НДС считается делением, а не умножением?", a: "НДС уже включён в цену. 1050₽ × 5 ÷ 105 = 50₽ — правильно. Если умножить 1050 × 5% = 52.50₽ — это ошибка." },
  ...
  { q: "Что такое «Сумма к выплате продавцу»?", a: "Это сумма, которую WB переводит вам на счёт. Цена товара минус комиссия, СПП и эквайринг. От неё считаются налоги." },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-4">
          ...
          <div className="font-mono text-[11px] leading-relaxed space-y-0.5">
            ...
            <div className="text-[var(--text-muted)] pl-4">↓ минус</div>
            <div className="text-[var(--accent)] pl-4">🏷️ Себестоимость + 🧾 НДС (из суммы продаж × ставка ÷ (100 + ставка)) + 🧾 УСН ((база − НДС) × ставка)</div>
